...
parser.add_argument('--periodic', dest='PERIODIC_BOUNDARIES', action=argparse.BooleanOptionalAction, default=False,
                    help="Use periodic instead of constant boundary conditions")
parser.add_argument('--show', dest='SHOW', action=argparse.BooleanOptionalAction, default=True,
                    help="Show the output heatmaps immediately")
parser.add_argument('--write', dest='WRITE', action=argparse.BooleanOptionalAction, default=True,
